...
var user_id = "<?php echo $tempname; ?>", CropPic="<?php echo $CropPic; ?>", firstPic="<?php echo $firstPic; ?>", toNewPic="<?php echo $toNewPic; ?>", toNewPic2="<?php echo $toNewPic2; ?>", toNewPic3="<?php echo $toNewPic3; ?>", toNewPic4="<?php echo $toNewPic4; ?>", beforAddText="<?php echo $beforAddText; ?>", cur_picture=document.getElementById('cur_picture').value, org_picture=document.getElementById('org_picture').value;
