...
/**
 * Mobile Detect
 * $Id: Mobiledtect.php 42 2012-04-26 20:57:17Z serbanghita@gmail.com $
 * 
 * @usage      require_once 'Mobiledtect.php';
 *             $detect = new Mobiledtect();
 *             $detect->isMobile() or $detect->isTablet()
 * 
 *             For more specific usage see the documentation navigate to:
 *             http://code.google.com/p/php-mobile-detect/wiki/Mobiledtect
 * 
